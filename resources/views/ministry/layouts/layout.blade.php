...
<body>
    <div class="wrapper">
        @include('ministry.layouts.sidebar');
        <div class="main-panel">
            @include('ministry.layouts.navbar');
            <div class="content">
                <div class="container-fluid">
                    @yield('main');
                </div>
            </div>
            @include('ministry.layouts.footer');
        </div>
    </div>
    <input type="hidden" id="pathInput" value="">
</body>
<!--   Core JS Files   -->
...
<script>
    $(document).ready(function() {
        ...
        $(element).closest("div").addClass("collapse in");
        $(element).closest("div").closest("li").addClass("active");
